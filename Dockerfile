...
RUN curl -L https://github.com/etcd-io/etcd/releases/download/v3.5.0/etcd-v3.5.0-linux-amd64.tar.gz \
    && tar xxzvf /etcd-v3.5.0-linux-amd64.tar.gz -C /software --strip-components=1 \
